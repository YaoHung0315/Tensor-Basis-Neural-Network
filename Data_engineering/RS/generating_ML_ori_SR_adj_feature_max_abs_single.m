...
step_h = 0.75; % change by case
target_points = 4000;
[x_point, y_point] = set_ML_triangle_point_R2023_1( x, y, target_points, step_h); % boundary have more point
...
[S_tensor_adj, R_tensor_adj] = get_ori_SR_adj_feature_Re(S_tensor, R_tensor, 260);   %250
S_tensor_max = 260;
R_tensor_max = 260;
