...
for i = 1:length(Hmax_values)
    mesh = generateMesh(model, 'Hmax', Hmax_values(i), 'GeometricOrder', 'quadratic', Hgrad=1.09, Hedge={[1], 0.18, [5], 0.21, [7], 0.21, [4], 0.24, [8], 0.24});
...
mesh = generateMesh(model, 'Hmax', optimal_Hmax,  'GeometricOrder', 'quadratic', Hgrad=1.09, Hedge={[1], 0.18, [5], 0.21, [7], 0.21, [4], 0.24, [8], 0.24});
% pdeplot(mesh);
