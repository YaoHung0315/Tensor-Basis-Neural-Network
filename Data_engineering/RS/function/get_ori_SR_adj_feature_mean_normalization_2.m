function [S_tensor_adj, R_tensor_adj] = get_ori_SR_adj_feature_mean_normalization_2( S_tensor, R_tensor, S_tensor_max, S_tensor_min, S_tensor_mean, R_tensor_max, R_tensor_min, R_tensor_mean );
    ...
    for j = 1:length(ori_cell)
        ...
        for row = 1:3
            for col = 1:3
                ...
                nor_tensor(row, col) = (tensor(row, col)) / (max_val - min_val);
