...
for i = 1:length(Hmax_values)
    mesh = generateMesh(model, 'Hmax', Hmax_values(i), 'GeometricOrder', 'quadratic', Hgrad=1.05, Hedge={[2], 0.0875, [4], 0.055});
...
mesh = generateMesh(model, 'Hmax', optimal_Hmax,  'GeometricOrder', 'quadratic', Hgrad=1.05, Hedge={[2], 0.0875, [4], 0.055});
% pdeplot(mesh);
