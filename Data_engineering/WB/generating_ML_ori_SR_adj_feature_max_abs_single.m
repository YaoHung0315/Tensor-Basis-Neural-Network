...
dir_root_l_r = [newPathPart '/Data_original_flow_field/Data_rawdata/WB/'];
dir_root_l_d = [newPathPart '/Data_original_flow_field/Data_distribution_psi_phi/WB/'];
dir_root_c =   [newPathPart '/Code_ML_TBNN/WB/function/'];
dir_root_s =   [newPathPart '/Data_ML_TBNN/WB/'];
dir_root_s =   [dir_root_s 'R2023_point/Data_ori_SR_adj_feature_max_abs_single'];
...
target_points = 3000;
[x_point, y_point] = set_ML_triangle_point_R2023_1( x, y, target_points);
% [x_point, y_point] = set_ML_senior_point( x, y);
...
[S_tensor_adj, R_tensor_adj] = get_ori_SR_adj_feature_Re(S_tensor, R_tensor, 300);
S_tensor_max = 300;
R_tensor_max = 300;
