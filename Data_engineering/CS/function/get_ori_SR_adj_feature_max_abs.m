function [S_tensor_adj, R_tensor_adj] = get_ori_SR_adj_feature_max_abs( S_tensor, R_tensor, S_tensor_max, S_tensor_min, R_tensor_max, R_tensor_min );
    ...
    for j = 1:length(ori_cell)
        ...
        for row = 1:3
            for col = 1:3
                ...
                nor_tensor(row, col) = (tensor(row, col)/max_val);
