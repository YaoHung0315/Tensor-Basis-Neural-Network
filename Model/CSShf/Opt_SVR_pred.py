...
# Load the saved model and scaler (SVR version)
...
version = get_next_version(output_dir, "svr_predictions", ".png")
plot_filename = os.path.join(output_dir, f"svr_predictions_{version:03d}.png")
...
spatial_version = get_next_version(output_dir, "svr_spatial", ".png")
spatial_plot_filename = os.path.join(output_dir, f"svr_spatial_{spatial_version:03d}.png")
