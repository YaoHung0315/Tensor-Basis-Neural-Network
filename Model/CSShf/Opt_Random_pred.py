...
# Load the saved model and scaler (Random Forest version)
...
print("Loaded Random Forest Model - Training RMSE:", rmse)
print("Loaded Random Forest Model - Training R2:", r2)

# Plot predictions vs. actual values
plt.figure(figsize=(10, 6))
plt.plot(Y_LES, label='Actual eddy_double_LES', color='green')
plt.plot(Y, label='Actual eddy_double_TBNN', color='blue')
plt.plot(Y_pred, label='RF Prediction', color='red', linestyle='--')
...
version = get_next_version(output_dir, "rf_predictions", ".png")
plot_filename = os.path.join(output_dir, f"rf_predictions_{version:03d}.png")
...
spatial_version = get_next_version(output_dir, "rf_spatial", ".png")
spatial_plot_filename = os.path.join(output_dir, f"rf_spatial_{spatial_version:03d}.png")
